 ...
 try {
  ...
  if (!(rs.next()))  {
   ...
   if (pwd.equals(request.getParameter("password"))) {
    sql = "update DataRoom set name= ? ,email=?,";
    ...
    if (cnt >0) {%>
<script>alert('정상적으로 수정되었습니다.'); location.href = "/freeboard_DataRoom/freeboard_listNotice.jsp?go=<%=request.getParameter("page")%>";</script>
<%} else {
