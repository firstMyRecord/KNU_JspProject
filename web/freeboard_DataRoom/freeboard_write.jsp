...
<P>                                           
<FORM name="msgwrite" method="post" action="/freeboard_DataRoom/freeboard_save.jsp">
<CENTER>
 ...
 <div class="container text-center">
  <form name="msgwrite" action="/freeboard_DataRoom/freeboard_save.jsp?table=DataRoom" class="form-horizontal" method="post">
