...
<div class="container marketing">
    <div class="row">
      <div class="col-lg-4" style="text-align: center">
        ...
        <h2>친구야, 나만 믿어</h2>
        <p>친구야, 나만 믿어의 간략한 설명</p>
        <p><a class="btn btn-secondary" data-bs-toggle="collapse" href="#친구야나만믿어" role="button" aria-expanded="false" aria-controls="collapseExample">자세히 보기</a></p>
        	<div class="collapse" id="친구야나만믿어">
        		<div class="d-grid gap-2 col-6 mx-auto">
				<a class="btn btn-secondary" href="./recommend.jsp" role="button">전공선택</a>
				<a class="btn btn-secondary" href="./program_list.jsp" role="button">사용프로그램 선택</a>
				</div>
			</div>
      </div><!-- /.col-lg-4 -->
      <div class="col-lg-4" style="text-align: center">
