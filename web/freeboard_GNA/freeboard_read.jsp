...
<div class="container" style="diplay:inline-block; text-align:center;">
    <td align="right" width="450"><A href="/freeboard_GNA/freeboard_listFag.jsp?go=<%=request.getParameter("id")%><img src="image/list.jpg" border=0></A></td>
    <td width="70" align="right"><A href="/freeboard_GNA/freeboard_rwrite.jsp?id=<%= request.getParameter("id")%>&page=<%=request.getParameter("page")%>"> <img src="image/reply.jpg" border=0></A></td>
    <td width="70" align="right"><A href="/freeboard_GNA/freeboard_upd.jsp?id=<%=id%>&page=1"><img src="image/edit.jpg" border=0></A></td>
    <td width="70" align="right"><A href="/freeboard_GNA/freeboard_del.jsp?id=<%=id%>&page=1"><img src="image/del.jpg"  border=0></A></td>
    </tr>
</div>
<%
            sql = "update GNA set readcount= readcount + 1 where id= ?" ;
            st = con.prepareStatement(sql);
            st.setInt(1, id);
            st.executeUpdate();
        }
