...
<div class="container text-center">
	<form name="msgdel" method=post action=/freeboard_GNA/freeboard_deldb.jsp>
	 ...
	 <input type="hidden" name="page" value="<%=request.getParameter("page")%>"  >
		...
		<div class="form-group row">
			...
			<a href="/freeboard_GNA/freeboard_listFag.jsp?go=<%=request.getParameter("id")%> <img src="image/list.jpg" border=0 class="img-fluid"></a>
			&nbsp;&nbsp;
