...
<div class="container text-center" style="background-color:#FFFFFF">
  <div class="form-group row">
		<div class = "my-box" align="center" style = "background-color:#FFFFFF; margin-bottom :30px" ><a href="freeboard_list.jsp?go=<%=request.getParameter("page")%>"><FONT color=black face=굴림 size=10><STRONG>수정 완료</STRONG></FONT></a></div>
		</div>
		</div>
