...
<div class="container-fluid bg-dark text-white">
	<div class="row">
		<div class="col-md-8 themed-grid-col s-txt"><p>			<h4>CheckList</h4>
			<div class="col-sm-8 themed-grid-col bg-light text-dark chk-div">
				항목: <a id="result"></a>
			</div>
		</div>
...
<div class="container-fluid" style="width: 75%;">
	<form action="specification.jsp" name="checkform" method="post">
		<table class="table table-hover table-light prog-table" id="Program_Table">
			<thead>
				<tr>
					<th class="th-1"></th>
					<th class="th-1"></th>
					<th class="th-2">프로그램 이름</th>
					<th class="th-2">Category
...
//				resultset의 내용중 m_prog들을 arrList에 추가
			...
			%>
				<tr>
					...
					%>
					/></td>
					<td><img class="td-img" src="./resources/images/<%=rs.getString("p_name")%>.png"></td>
		...
		<div>
			<input class="btn btn-secondary" type="button" value="선택완료 &raquo;" id="selectBtn" onclick="noCheck()" style="float: right;">
		</div>
	</form>
</div>
<p>
