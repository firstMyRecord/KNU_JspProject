...
<P>                                           
<FORM name="msgwrite" method="post" action="/freeboard/freeboard_save.jsp">
<CENTER>
 ...
 <div class="container text-center">
  <form name="msgwrite" action="/freeboard/freeboard_save.jsp?table=freeboard" class="form-horizontal" method="post">
