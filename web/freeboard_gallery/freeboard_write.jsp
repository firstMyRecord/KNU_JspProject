...
<P>                                           
<FORM name="msgwrite" method="post" action="/freeboard_gallery/freeboard_save.jsp">
<CENTER>
 ...
 <div class="container text-center">
  <form name="msgwrite" action="/freeboard_gallery/freeboard_save.jsp?table=gallery" class="form-horizontal" method="post">
