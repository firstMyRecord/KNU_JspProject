...
<div class="container text-center">
 <FORM name="msgwrite" method=POST action="/freeboard_Fag/freeboard_upddb.jsp?id=<%=id%>&page=<%=p%>">
  ...
  <div class="form-group row">
   <div class="col-12" style="display:inline-block; text-align:center;">
    ...
    &nbsp;&nbsp;
    <A href="/freeboard_Fag/freeboard_listFag.jsp.jsp?go=<%=request.getParameter("id")%> <img src="image/list.jpg" border=0 class="img-fluid"></a>
   </div>
  </div>
 </form>
 <%
