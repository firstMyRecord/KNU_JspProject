...
<P>                                           
<FORM name="msgwrite" method="post" action="/freeboard_Fag/freeboard_saveFag.jsp">
<CENTER>
 ...
 <div class="container text-center">
  <form name="msgwrite" action="/freeboard_Fag/freeboard_saveFag.jsp?table=Fag" class="form-horizontal" method="post">
