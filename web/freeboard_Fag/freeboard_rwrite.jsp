...
// Connection con= null;
 ...
 try {
  sql = "select * from Fag where id="+id ;
  ...
  %>
  <div class="container">
	<form name="msgrewrite" action="/freeboard_Fag/freeboard_rsave.jsp?id=<%=id%>&page=<%=request.getParameter("page")%>" class="form-horizontal" method="post">
...
<%=cont%></textarea>
		...
		<div class="form-group row">
			<div class="col-12" style="display:inline-block; text-align:center;">
				...
				&nbsp;&nbsp;
				<a href="/freeboard_Fag/freeboard_listNotice.jsp?go=<%=request.getParameter("id")%><img src="image/list.jpg" class="img-fluid"></a>
			</div>
		</div>
